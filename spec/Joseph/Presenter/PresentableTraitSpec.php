...
namespace spec\Joseph\Presenter;
...
{
    function let(){
        $this->beAnInstanceOf('spec\Joseph\Presenter\Foo');
    }

    function it_is_initializable()
    {
        $this->shouldHaveType('spec\Joseph\Presenter\Foo');
    }
    ...
    function it_throws_up_if_invalid_presenter_is_provided()
    {
        ...
        $this->shouldThrow('Joseph\Presenter\Exceptions\PresenterException')->duringPresent();
    }
    ...
    function it_caches_the_presenter_for_future_use()
    {
        ...
        $one->shouldBe($two);
        //$this->present()->shouldBe($this->present());
    }
}

class Foo {
    use \Joseph\Presenter\PresentableTrait;
